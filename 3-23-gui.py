# -*- coding: utf-8 -*-
"""
Created on Tue Mar 23 19:49:07 2021
...
class Ui_RunWindow(object):
    def setupUi(self, RunWindow):
        ...
        self.pushButton_17.clicked.connect(lambda: self.getFilePath())
    ...
    def retranslateUi(self, RunWindow):
        ...
        self.pushButton_19.clicked.connect(lambda: self.getFilePath())
