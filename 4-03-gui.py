...
# Form implementation generated from reading ui file '3-23-gui.ui'
#
...
class Ui_RunWindow(object):
    def setupUi(self, RunWindow):
        ...
        self.pushButton_4.clicked.connect(self.saveConfigurationRun)
        ...
        self.pushButton_21.clicked.connect(self.saveToolSpecification)  
        ...
        self.comboBox_5.setGeometry(QtCore.QRect(10, 100, 104, 26))
        self.comboBox_5.setObjectName("comboBox_5")
        self.comboBox_5.addItem("")
        self.comboBox_5.addItem("")
        self.label_16 = QtWidgets.QLabel(self.groupBox_10)
        self.label_16.setGeometry(QtCore.QRect(10, 70, 101, 16))
        self.label_16.setObjectName("label_16")
        self.label_17 = QtWidgets.QLabel(self.groupBox_10)
        self.label_17.setGeometry(QtCore.QRect(130, 70, 61, 16))
        self.label_17.setObjectName("label_17")
        self.label_18 = QtWidgets.QLabel(self.groupBox_10)
        self.label_18.setGeometry(QtCore.QRect(250, 70, 61, 16))
        self.label_18.setObjectName("label_18")
        self.pushButton_14 = QtWidgets.QPushButton(self.groupBox_10)
        self.pushButton_14.setGeometry(QtCore.QRect(350, 100, 81, 32))
        self.pushButton_14.setObjectName("pushButton_14")
        self.textEdit_6 = QtWidgets.QTextEdit(self.groupBox_10)
        self.textEdit_6.setGeometry(QtCore.QRect(40, 200, 361, 221))
        self.textEdit_6.setObjectName("textEdit_6")
        self.label_19 = QtWidgets.QLabel(self.groupBox_10)
        self.label_19.setGeometry(QtCore.QRect(140, 170, 161, 16))
        self.label_19.setObjectName("label_19")
        self.comboBox_6 = QtWidgets.QComboBox(self.groupBox_10)
        self.comboBox_6.setGeometry(QtCore.QRect(130, 100, 104, 26))
        ...
        self.pushButton_15.clicked.connect(self.saveToolDependency) 
        ...
        self.textEdit_17.setGeometry(QtCore.QRect(250, 100, 101, 21))
    ...
    def retranslateUi(self, RunWindow):
        ...
        row_value = self.getNewToolNameConfigurationRun(0)
        item.setText(_translate("RunWindow", row_value))
        item = self.RunListTable.item(0, 1)
        description_value = self.get_descript(0)
        item.setText(_translate("RunWindow", description_value))
        item = self.RunListTable.item(1, 0)
        row_value = self.getNewToolNameConfigurationRun(1)
        item.setText(_translate("RunWindow", row_value))
        item = self.RunListTable.item(1, 1)
        description_value = self.get_descript(1)
        item.setText(_translate("RunWindow", description_value))
        item = self.RunListTable.item(2, 0)
        row_value = self.getNewToolNameConfigurationRun(2)
        item.setText(_translate("RunWindow", row_value))
        item = self.RunListTable.item(2, 1)
        description_value = self.get_descript(2)
        item.setText(_translate("RunWindow", description_value))
        #item = self.RunListTable.item(3, 0)
        #row_value = self.getNewToolNameConfigurationRun(3)
        #item.setText(_translate("RunWindow", row_value))
        ...
        self.pushButton_22.clicked.connect(lambda: self.getFilePath(22))
        ...
        row_value = self.getNewToolNameToolSpecification(0)
        item.setText(_translate("RunWindow", row_value))
        item = self.RunListTable_2.item(1, 0)
        row_value = self.getNewToolNameToolSpecification(1)
        item.setText(_translate("RunWindow", row_value))
        item = self.RunListTable_2.item(2, 0)
        row_value = self.getNewToolNameToolSpecification(2)
        item.setText(_translate("RunWindow", row_value))
        item = self.RunListTable_2.item(3, 0)
        row_value = self.getNewToolNameToolSpecification(3)
        item.setText(_translate("RunWindow", row_value))
        item = self.RunListTable_2.item(4, 0)
        row_value = self.getNewToolNameToolSpecification(4)
        item.setText(_translate("RunWindow", row_value))
        ...
        self.pushButton_9.clicked.connect(lambda: self.removeToolList(0))
        self.pushButton_9.clicked.connect(lambda: self.showDialog())
        self.pushButton_10.setText(_translate("RunWindow", "Remove"))
        self.pushButton_10.clicked.connect(lambda: self.removeToolList(1))
        self.pushButton_10.clicked.connect(lambda: self.showDialog())
        self.pushButton_11.setText(_translate("RunWindow", "Remove"))
        self.pushButton_11.clicked.connect(lambda: self.removeToolList(2))
        self.pushButton_11.clicked.connect(lambda: self.showDialog())
        self.pushButton_12.setText(_translate("RunWindow", "Remove"))
        self.pushButton_12.clicked.connect(lambda: self.removeToolList(3))
        self.pushButton_12.clicked.connect(lambda: self.showDialog())
        self.pushButton_13.setText(_translate("RunWindow", "Remove"))
        self.pushButton_13.clicked.connect(lambda: self.removeToolList(4))
        self.pushButton_13.clicked.connect(lambda: self.showDialog())
        ...
        self.pushButton_17.clicked.connect(lambda: self.getFilePath(17))
...
#Create Save function for Configuration of Selected Run        
    def saveConfigurationRun(self):
        ...
        run_name = self.textEdit_12.toPlainText()
        run_description = self.textEdit_13.toPlainText()
        ...
        self.updateRunListAddedTool(run_name)
        self.updateRunListAddedToolDes(run_description)
...
#Update the run list table when there's a new value
    def updateRunListAddedTool(self, new_tool):
        
        row = self.nextAvailableRowConfigRun()
        
        row = row - 1
        
        item = self.RunListTable.item(row, 0)

        print("JUST ADDED: ", new_tool)
        
        _translate = QtCore.QCoreApplication.translate
        
        item.setText(_translate("RunWindow", new_tool))

    def updateRunListAddedToolDes(self, des):
        
        row = self.nextAvailableRowConfigRun()
        
        row = row - 1
        
        item = self.RunListTable.item(row, 1)

        print("JUST ADDED: ", des)
        
        _translate = QtCore.QCoreApplication.translate
        
        item.setText(_translate("RunWindow", des))

#Update the tool list table when there's a new value
    def updateToolListAddedTool(self, new_tool):
        
        row = self.nextAvailableRowToolSpecification()
        
        row = row - 1
        
        item = self.RunListTable_2.item(row, 0)
...
#Return the next available row    
    def nextAvailableRowToolSpecification(self):
...
#Return the next available row    
    def nextAvailableRowConfigRun(self):
...
#Create Save function for Tool Specification       
    def saveToolSpecification(self):
        ...
        tool_description = self.textEdit_7.toPlainText()
        ...
        self.updateToolListAddedTool(tool_name)
...
#Update the tool list when a tool is removed    
    def updateToolListRemovedTool(self):
        cluster = Cluster(['127.0.0.1'], port=9042)       
           # Database Credentials
        session = cluster.connect() 
        ...
        for i in range(count):
            ...
            item = self.RunListTable_2.item(i, 0)
        
            row_value = self.getNewToolNameToolSpecification(i)
...
#Remove from Tool List      
    def removeToolList(self, button):
        
        cluster = Cluster(['127.0.0.1'], port=9042)       
           # Database Credentials
        session = cluster.connect() 
        
        tool = self.RunListTable_2.item(button, 0)
        ...
        print("tool to be revmoed:", remove_tool)
        ...
        batch=BatchStatement()
        batch.add(SimpleStatement("DELETE FROM Tool_Specification WHERE tool_name=%s"), ([remove_tool]))
        ...
        self.updateToolListRemovedTool()

#Return the tool name of the added tool      
    def getNewToolNameConfigurationRun(self, row):
        ...
        if row >= count:
            ...
            data = session.execute("SELECT run_name FROM tutorialspoint.configuration_run;")
            
            print("row to get the value from the table", row)
        
            tool = data[row]
            print("position data[row]", data[row])
    ...
    def get_descript(self, row):
        ...
        if row >= count:
            ...
            data = session.execute("SELECT run_description FROM tutorialspoint.configuration_run;")
            ...
            #Close connection
            session.shutdown()
            print(tool.run_description)
        
            return tool.run_description
        
#Return the tool name of the added tool      
    def getNewToolNameToolSpecification(self, row):
        ...
        if row >= count:
            ...
            data = session.execute("SELECT tool_name FROM tutorialspoint.tool_specification;")
...
#Browse Button
    def getFilePath(self, button):
        ...
        if button == 17:
            self.textEdit_8.setText(file_path)
        
        #Tool specification Browse button    
        if button == 19:
            self.textEdit_10.setText(file_path)
            
        #Run configuration file browse button    
        if button == 22:  
            self.textEdit_16.setText(file_path)
...
#Create Save function for Tool Dependency       
    def saveToolDependency(self):
        ...
        batch=BatchStatement()
        dependent_data = self.comboBox_5.currentText()
        operator = self.comboBox_6.currentText()
        value = self.textEdit_17.toPlainText()
        dependency_expression = self.textEdit_6.toPlainText()
        

        batch.add(SimpleStatement("INSERT INTO Tool_Dependency (dependent_data, operator, value, dependency_expression) VALUES (%s, %s, %s, %s)"), (dependent_data, operator, value, dependency_expression))
